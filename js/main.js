...
const DEFAULT_LAYOUT = [
  // Fitnessruimte (zwarte zaal) — overgenomen uit Max' eigen indeling (juli 2026)
  { type: 'minitrampoline', x: -7.01, z: 2.01, rot: 10.21 },
  { type: 'stellingkast', x: -1.61, z: -2.28, rot: 4.713 },
  { type: 'kettlebellrek', x: 0.37, z: -2.13, rot: 1.571 },
  { type: 'dumbbellrek_chroom', x: -0.81, z: -1.42, rot: 0 },
  { type: 'plyobox60', x: -5.55, z: -2.58, rot: 0 },
  { type: 'plyobox30_oranje', x: -3.63, z: -2.5, rot: 0 },
  { type: 'medicijnballen', x: 3.52, z: 2.68, rot: 3.142 },
  { type: 'sandbag', x: 2.07, z: 2.4, rot: 0 },
  { type: 'stangenrek', x: -5.63, z: 2.53, rot: 1.571 },
  { type: 'dumbbellrek_zwart', x: 5.72, z: -2.53, rot: 6.284 },
  { type: 'verstelbank', x: 1.39, z: -2.18, rot: 0 },
  { type: 'dumbbellrek_zwart', x: 4.5, z: -2.53, rot: 0 },
  { type: 'legextension', x: 9.13, z: -0.79, rot: 7.854 },
  { type: 'legcurl', x: 9.03, z: 0.5, rot: 4.712 },
  { type: 'mattenrek', x: 9.51, z: -2.23, rot: 1.571 },
  { type: 'spiegel', x: -7.83, z: 1.98, rot: 1.571 },
  { type: 'halfrack', x: -7.08, z: -1.45, rot: 1.571 },
  { type: 'ghd', x: 9.01, z: 2.01, rot: 7.069 },
  { type: 'halfrack', x: -7.08, z: 1.12, rot: 1.571 },
  { type: 'spiegel', x: -7.83, z: 0.43, rot: 7.854 },
  { type: 'spiegel', x: -7.83, z: -0.86, rot: 1.571 },
  { type: 'spiegel', x: -7.83, z: -1.98, rot: 1.571 },
  { type: 'plyobox45_grijs', x: -4.64, z: -2.53, rot: 0 },
  { type: 'ballentoren', x: 2.5, z: 2.58, rot: 0 },
  { type: 'stellingkast', x: -0.21, z: -2.28, rot: 1.571 },
  { type: 'verstelbank', x: 2.2, z: -2.18, rot: 0 },
  { type: 'verstelbank', x: 3.01, z: -2.18, rot: 0 },
  { type: 'benchpress', x: -1.08, z: 2.18, rot: 3.142 },
  { type: 'schijvenrek_grond', x: -3.38, z: 2.61, rot: 0 },

  // Blauwe zaal — overgenomen uit Max' eigen indeling (juli 2026)
  { type: 'loopband_matrix', x: 28.3, z: 1.11, rot: 1.571 },
  { type: 'crosstrainer', x: 28.51, z: -4.27, rot: 1.571 },
  { type: 'hometrainer', x: 24.32, z: -4.09, rot: 9.425 },
  { type: 'spinningfiets', x: 19.64, z: -4.2, rot: 3.142 },
  { type: 'spinningfiets', x: 20.55, z: -4.2, rot: 3.142 },
  { type: 'spinningfiets', x: 21.57, z: -4.2, rot: 9.425 },
  { type: 'flowin', x: 17.67, z: 3.07, rot: 0 },
  { type: 'buikspierbank', x: 26.45, z: -4.08, rot: 6.283 },
  { type: 'aerobicstep', x: 17.61, z: 4.23, rot: 0 },
  { type: 'aerobicstep', x: 17.6, z: 4.68, rot: 0 },
  { type: 'plyobox60', x: 16.5, z: 3.19, rot: 0 },
  { type: 'fietstrainer_zilver', x: 22.51, z: -4.2, rot: 9.425 },
  { type: 'fietstrainer_zilver', x: 23.41, z: -4.2, rot: 9.425 },
  { type: 'fietstrainer_zilver', x: 18.73, z: -4.2, rot: 9.425 },
  { type: 'halfrack', x: 25.08, z: 3.54, rot: 17.279 },
  { type: 'buikspierbank', x: 25.56, z: -4.08, rot: 0 },
  { type: 'medicijnballen', x: 16.62, z: 2.53, rot: 0 },
  { type: 'legpress', x: 16.69, z: -2.17, rot: 3.142 },
  { type: 'tv_wand', x: 17.19, z: -4.18, rot: 7.854 },
  { type: 'keiser', x: 18.71, z: 4.46, rot: 3.142 },
  { type: 'keiser', x: 20.69, z: 4.46, rot: 3.142 },
  { type: 'roeimachine', x: 28.68, z: 0.15, rot: 4.712 },
  { type: 'mattenrek', x: 25.23, z: 2.3, rot: 0 },
];
